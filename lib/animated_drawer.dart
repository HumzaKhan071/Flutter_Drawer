...
class AnimatedDraw extends StatefulWidget {
  const AnimatedDraw({Key? key}) : super(key: key);

  @override
  _AnimatedDrawState createState() => _AnimatedDrawState();
}

class _AnimatedDrawState extends State<AnimatedDraw> {
  @override
